...
Only state can be modified.`);
  ...
  const initializeFromScript = () => {
    ...
    if (script) {
      ...
      window.GrowDeskConfig = {
        ...window.GrowDeskConfig || {},
        brandName: brandName || ((_a = window.GrowDeskConfig) == null ? void 0 : _a.brandName),
        welcomeMessage: welcomeMessage || ((_b = window.GrowDeskConfig) == null ? void 0 : _b.welcomeMessage),
        primaryColor: primaryColor || ((_c = window.GrowDeskConfig) == null ? void 0 : _c.primaryColor),
        position: position || ((_d = window.GrowDeskConfig) == null ? void 0 : _d.position)
      };
  ...
  const _hoisted_1 = {
    key: 0,
    class: "pi pi-comments text-white"
  };
  const _hoisted_2 = {
    key: 1,
  ...
  const _hoisted_6 = {
    key: 0,
    class: "flex-1 p-4 overflow-y-auto bg-gray-50 flex flex-col"
  };
  const _hoisted_7 = { class: "text-center text-gray-700 mb-4" };
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", null, [
          vue.createElementVNode("div", {
            ...
            !isOpen.value ? (vue.openBlock(), vue.createElementBlock("i", _hoisted_1)) : (vue.openBlock(), vue.createElementBlock("i", _hoisted_2))
          ], 4),
          isOpen.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [
            vue.createElementVNode("div", {
              ...
              vue.createElementVNode("h3", _hoisted_4, vue.toDisplayString(__props.brandName), 1),
              vue.createElementVNode("div", _hoisted_5, [
                isRegistered.value ? (vue.openBlock(), vue.createElementBlock("i", {
                  key: 0,
                  class: "pi pi-sign-out cursor-pointer mr-3",
                  onClick: vue.withModifiers(logout, ["stop"]),
                  title: "Cerrar sesión"
            ...
            !isRegistered.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_6, [
              vue.createElementVNode("div", _hoisted_7, vue.toDisplayString(__props.welcomeMessage), 1),
              vue.createElementVNode("form", {
                onSubmit: vue.withModifiers(submitRegistration, ["prevent"]),
                ...
                vue.createElementVNode("div", _hoisted_8, [
                  ...
                  vue.withDirectives(vue.createElementVNode("input", {
                    ...
                    style: vue.normalizeStyle({ "--tw-ring-color": __props.primaryColor }),
                    required: ""
                  }, null, 4), [
                    [vue.vModelText, userData.value.name]
                  ])
                ]),
                vue.createElementVNode("div", _hoisted_9, [
                  ...
                  vue.withDirectives(vue.createElementVNode("input", {
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => userData.value.email = $event),
                    type: "email",
                    id: "email",
                    class: "border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2",
                    style: vue.normalizeStyle({ "--tw-ring-color": __props.primaryColor }),
                    ...
                    [vue.vModelText, userData.value.email]
                  ])
                ]),
                vue.createElementVNode("div", _hoisted_10, [
                  ...
                  vue.withDirectives(vue.createElementVNode("textarea", {
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => userData.value.initialMessage = $event),
                    id: "firstMessage",
                    rows: "3",
                    class: "border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2",
                    style: vue.normalizeStyle({ "--tw-ring-color": __props.primaryColor }),
                    ...
                    [vue.vModelText, userData.value.initialMessage]
                  ])
                ]),
  ...
  const initializeWidget = () => {
    ...
    const app = vue.createApp(_sfc_main, {
      ...
      brandName: ((_a = window.GrowDeskConfig) == null ? void 0 : _a.brandName) || "GrowDesk",
      welcomeMessage: ((_b = window.GrowDeskConfig) == null ? void 0 : _b.welcomeMessage) || "¿Necesitas ayuda? Estamos aquí para ayudarte.",
      primaryColor: ((_c = window.GrowDeskConfig) == null ? void 0 : _c.primaryColor) || "#1976d2",
      position: ((_d = window.GrowDeskConfig) == null ? void 0 : _d.position) || "bottom-right",
      logoUrl: ((_e = window.GrowDeskConfig) == null ? void 0 : _e.logoUrl) || ""
    });
    app.use(pinia);
    app.mount(container);
